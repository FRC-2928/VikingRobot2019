...
public class RobotConstants {
    ...
    public static final double THREAD_ENCODER_TICKS_TO_BALL = 5.75; //6.25 for fully inflated balls 
    ...
    public static final double LIMELIGHT_ROCKET_TAPE_INCHES_PER_DEGREES = 0.615;
    ...
    public static final long ELEVATOR_STOP_THRESHOLD = 2; //placeholder
